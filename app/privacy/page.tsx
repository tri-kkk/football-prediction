    ...
    <div className="bg-[#1a1a1a] rounded-2xl p-8 border border-gray-800 space-y-8">
      ...
      <section>
        ...
        <h3 className="text-xl font-semibold mb-3 mt-6 text-blue-400">
          {isKo ? '2.2 구독/결제 시 수집 정보' : '2.2 Information Collected During Subscription/Payment'}
        </h3>
        <p className="text-gray-300 mb-3">
          {isKo 
            ? '프리미엄 구독 결제 시 다음 정보가 수집될 수 있습니다:'
            : 'When subscribing to premium, the following information may be collected:'}
        </p>
        <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
        ...
        <p className="text-gray-400 text-sm mt-2">
          {isKo 
            ? '※ 신용카드 번호 등 민감한 결제 정보는 회사가 직접 저장하지 않으며, 안전한 PG사(결제대행사)를 통해 처리됩니다.'
            : '※ Sensitive payment information such as credit card numbers are not stored directly by the Company and are processed through secure payment gateways.'}
        </p>
      ...
      <section>
        ...
        <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
          ...
          <li>{isKo ? '프리미엄 구독 관리 및 결제 처리' : 'Premium subscription management and payment processing'}</li>
          ...
          <li>{isKo ? '서비스 관련 공지사항 전달' : 'Delivering service-related announcements'}</li>
      ...
      <section>
        ...
        <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
          ...
          <li>
            <strong>{isKo ? '결제대행사 (PG):' : 'Payment Gateway (PG):'}</strong>{' '}
            {isKo ? '안전한 결제 처리' : 'Secure payment processing'}
          </li>
        </ul>
      ...
      <section>
        <h2 className="text-2xl font-bold mb-4 text-white">
          {isKo ? '7. 데이터 보안' : '7. Data Security'}
        </h2>
        <p className="text-gray-300">
          {isKo 
            ? '저희는 귀하의 개인정보를 보호하기 위해 적절한 기술적 및 조직적 보안 조치를 시행합니다. 여기에는 SSL 암호화, 안전한 서버 환경, 접근 권한 관리 등이 포함됩니다. 그러나 인터넷을 통한 전송 방법이나 전자 저장 방법이 100% 안전하다고 보장할 수 없습니다.'
            : 'We implement appropriate technical and organizational security measures to protect your personal information, including SSL encryption, secure server environment, and access control. However, no method of transmission over the Internet or electronic storage is 100% secure.'}
        </p>
      </section>
      ...
      <section>
        <h2 className="text-2xl font-bold mb-4 text-white">
          {isKo ? '9. 개인정보 처리방침의 변경' : '9. Changes to This Privacy Policy'}
        </h2>
        <p className="text-gray-300">
          {isKo 
